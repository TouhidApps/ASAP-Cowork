...
/** The documentation agent's tool roster — inspecting the codebase and writing a README/architecture doc are both things [TerminalTool] already does (reading files, writing via a heredoc). */
object DocumentationTools {
